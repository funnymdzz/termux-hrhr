...
yes | /usr/local/lib/android/tools/bin/sdkmanager --licenses

# The android platforms are used in the ecj and apksigner packages:
yes | /usr/local/lib/android/tools/bin/sdkmanager "platform-tools" "build-tools;${TERMUX_ANDROID_BUILD_TOOLS_VERSION}" "platforms;android-28" "platforms;android-24" "platforms;android-21"
